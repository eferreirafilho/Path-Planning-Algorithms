...
function [S,V,E,map_grid] = PRM_pre_phase(size_x,size_y,obstacles,n,gamma_gain)
...
var_radius=gamma_prm*(log(n)/n)^(1/dim);


% Create a graph
for i=1:n   %Algorithm 1 - sPRM - line 2 
   ...
   V_near=near(dist,var_radius,V_list);
    
      
    %Algorithm 1 - PRM - line 3 - V  <- V U xrand
    S.add_element(v_new);
